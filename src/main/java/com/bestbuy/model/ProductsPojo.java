...
public class ProductsPojo {
    ...
    public static ProductsPojo getProductsPojo(String name, String type, Double price, Integer shipping, String upc, String description, String manufacturer, String model, String url, String image) {
